...
public class IFTimerManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!isRunning || theGameStateManager == null || theGameStateManager.currentState != IFGameState.Play) return;
        ...
        if (currentTime <= 0)
        {
            ...
            currentTime = 0;
            theGameStateManager.SetState(IFGameState.End);
        }
    }
