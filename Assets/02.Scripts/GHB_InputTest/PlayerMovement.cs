...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // --- 이동 로직 ---
        Vector2 leftTrackpadInput = ViveInput.GetPadAxis(HandRole.LeftHand);
        Vector3 moveInput = new Vector3(leftTrackpadInput.x, 0f, leftTrackpadInput.y);
        ...
        Vector3 horizontalMove = (forwardDirection * moveInput.z + rightDirection * moveInput.x) * movementSpeed;
        Vector3 finalMove = horizontalMove * Time.deltaTime + _verticalVelocity * Time.deltaTime;
